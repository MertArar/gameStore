...
import { ReactComponent as Browse } from "../../Resources/images/browse.svg";
import { ReactComponent as Cart } from "../../Resources/images/cart.svg";
    ...
    <>
      ...
      >
        <div className={styles.navbar_left}>
          <div className={styles.logodiv} id="0" onClick={handleHome}>
        ...
        <div className={styles.navbar_right}>
          ...
          <div className={styles.cartdiv} id="3" onClick={handleOpenCart}>
            <Cart
